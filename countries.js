// Get a reference to the element(s) with n-country="nigeria"
const countryElements = document.querySelectorAll('[n-country="nigeria"]');
...
navigator.geolocation.getCurrentPosition(position => {
  ...
  fetch(mapboxAPIUrl)
    ...
    .then(data => {
      ...
      // Set the display property of the elements based on whether the user is in Nigeria or not
