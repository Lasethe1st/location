// Get a reference to the element(s) with n-country="india"
const countryElements = document.querySelectorAll('[n-country="india"]');
...
navigator.geolocation.getCurrentPosition(position => {
  ...
  fetch(mapboxAPIUrl)
    ...
    .then(data => {
      ...
      // Set the display property of the elements based on whether the user is in India or not
