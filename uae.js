// Get a reference to the element(s) with n-country="uae"
const countryElements = document.querySelectorAll('[n-country="uae"]');
...
navigator.geolocation.getCurrentPosition(position => {
  ...
  fetch(mapboxAPIUrl)
    ...
    .then(data => {
      // Check if the user is in the United Arab Emirates
      ...
      // Set the display property of the elements based on whether the user is in the UAE or not
